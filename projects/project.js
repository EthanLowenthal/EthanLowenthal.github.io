...
function setup() {
  ...
  bggSlider = createSlider(0, 255, 236);
  bggSlider.position(300, 60);
  bgbSlider = createSlider(0, 255, 155);
...
function draw() {
  ...
  if (bgrSlider.value() - 10 < rSlider.value()){
    if (bgrSlider.value() + 10 > rSlider.value()){
      if (bggSlider.value() - 10 < gSlider.value()){
        if (bggSlider.value() + 10 > gSlider.value()){
          if (bgbSlider.value() - 10 < bSlider.value()){
            if (bgbSlider.value() + 10 > bSlider.value()){
